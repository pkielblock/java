...
public class Main {
    public static void main(String[] args) {
        ...
        Instant d06 = Instant.parse("2022-07-20T01:58:26Z");
        ...
        //Instant doesn't have .format() method, we need to call .withZone(ZoneId.~) in the DateTimeFormatter
        //And then call the .format() from the DateTimeFormatter
